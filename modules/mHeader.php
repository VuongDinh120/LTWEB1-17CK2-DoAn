                ...
                <div class="modal-body">
                    <form name="frmLogin" action="/modules/xlDangNhap.php" method="post" onsubmit="return KiemTraDangNhap()">
                        <div class="form-group">
                            <input type="text" class="form-control" name="txtUS" placeholder="Tên đăng nhập" required="required">
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control" name="txtPS" placeholder="Mật khẩu" required="required">
                        </div>
                        <div class="form-group">
    ...
    <div class="top-header">
        ...
        <div class="login-container">
            ...
            ?>
                ...
                <a href="#" onclick="ChuyenTrangDangKy()">
                    <h6>Đăng ký</h6>
                </a>
