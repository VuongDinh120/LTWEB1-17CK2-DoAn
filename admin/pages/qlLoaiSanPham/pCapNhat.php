...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="pages/qlLoaiSanPham/xlCapNhat.php" method="GET" onsubmit="return KiemTra();">
                <!-- Modal Header -->
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="col-8">
                            ...
                            <input type="text" name="txtTen" class="form-control" id="txtTen" value="<?php echo $row["TenLoaiSanPham"] ?>">
